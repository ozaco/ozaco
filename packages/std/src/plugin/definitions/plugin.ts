...
declare global {
  namespace Std {
    ...
    namespace Plugin {
      ...
      type Instance<M extends Std.Plugin.AnyMeta, R = EmptyType, T = Std.Plugin.BaseTags<M>, D extends Std.Plugin.AnyDependency = EmptyType> = {
        meta: M
        tags: T
        dependencies: D
      ...
      interface Base<M extends Std.Plugin.AnyMeta, R = EmptyType, T = Std.Plugin.BaseTags<M>, D extends Std.Plugin.AnyDependency = EmptyType> {
        readonly meta: M
        readonly tags: T
        ...
        direct: <N extends string, C extends Promisify<Std.Plugin.Actions.Context<N, M, BlobType, T, D>>>(
          ...
          : Std.Plugin.Actions.Async<N, M, Std.Plugin.Actions.InferResult<Awaited<C>>, Std.Plugin.Actions.InferTags<Awaited<C>>, D, true>
        ...
        action: <N extends string, C extends Promisify<Std.Plugin.Actions.Context<N, M, BlobType, T, D>>>(
          ...
          : Std.Plugin.Actions.Async<N, M, Std.Plugin.Actions.InferResult<Awaited<C>>, Std.Plugin.Actions.InferTags<Awaited<C>>, D, false>
      }

      interface Sync<M extends Std.Plugin.AnyMeta, R = EmptyType, T = Std.Plugin.BaseTags<M>, D extends Std.Plugin.AnyDependency = EmptyType> extends Std.Plugin.Base<M, R, T, D> {
      ...
      interface Async<M extends Std.Plugin.AnyMeta, R = EmptyType, T = Std.Plugin.BaseTags<M>, D extends Std.Plugin.AnyDependency = EmptyType> extends Std.Plugin.Base<M, R, T, D> {
      ...
      type BaseTags<M extends Std.Plugin.Meta<BlobType, BlobType, BlobType>> = Std.Plugin.$BaseTags<Std.Plugin.InferName<M>, Std.Plugin.InferVersion<M>>

      // Plugin Shortcuts

      type AnyDependency = Record<string, Std.Plugin.AnyInstance>

      type AnyPlugin = Std.Plugin.Sync<BlobType, BlobType, BlobType, BlobType> | Std.Plugin.Async<BlobType, BlobType, BlobType, BlobType>

      type BasePlugin<M extends Std.Plugin.Meta<BlobType, BlobType, BlobType>> = Std.Plugin.Sync<M, EmptyType, Std.Plugin.BaseTags<M>, EmptyType>
